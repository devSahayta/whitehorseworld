  ...
  return (
    <>
      ...
      <div className="bg-white text-black min-h-screen py-16">
        ...
        <section className="bg-yellow-400/90 text-black py-28 px-4 md:px-20 text-center mt-14 ">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <motion.div
              ...
              className="bg-white/25 p-6 rounded-xl shadow-[0_4px_60px_rgba(255,255,255,0.05)] border border-black/10 py-12"
            >
        ...
        <section className="bg-white py-24 px-4 md:px-20 text-center text-black">
          <motion.h2
            initial={{ opacity: 0, y: 50 }}
            whileInView={{ opacity: 1, y: 0 }}
            transition={{
